...
- Detached signatures will then be committed to the [ascension-detached-sigs](https://github.com/ascension-core/ascension-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
people without access to `ascension.org` to download the binary distribution.
Also put it into the `optional_magnetlink:` slot in the YAML file for
ascension.org (see below for ascension.org update instructions).

- Update ascension.org version

  - First, check to see if the Ascension.org maintainers have prepared a
    release: https://github.com/ascension-dot-org/ascension.org/labels/Releases

      - If they have, it will have previously failed their Travis CI
        checks because the final release files weren't uploaded.
        Trigger a Travis CI rebuild---if it passes, merge.

  - If they have not prepared a release, follow the Ascension.org release
    instructions: https://github.com/ascension-dot-org/ascension.org#release-notes
...
- Announce the release:
  ...
  - Notify BlueMatt so that he can start building [the PPAs](https://launchpad.net/~ascension/+archive/ubuntu/ascension)
