...
This document provides guidelines for internationalization of the Ascension Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `ascension_en.ts` remains unchanged.
