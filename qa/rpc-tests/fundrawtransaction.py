...
class RawTransactionsTest(AscensionTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid ascension address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid ascension address" in e.error['message'])
