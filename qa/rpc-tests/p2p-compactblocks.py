...
# TestNode: A peer we use to send messages to ascensiond, and store responses.
...
class CompactBlocksTest(AscensionTestFramework):
    ...
    # This test actually causes ascensiond to (reasonably!) disconnect us, so do this last.
    ...
    # Test that ascensiond requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for ascensiond to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # ascensiond will not send blocktxn responses for blocks whose height is
