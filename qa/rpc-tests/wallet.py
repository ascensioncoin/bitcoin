...
class WalletTest (AscensionTestFramework):
    ...
    def run_test (self):
        ...
        # Send 21 ASN from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 ASN with subtract fee from amount
        ...
        # Sendmany 10 ASN with subtract fee from amount
