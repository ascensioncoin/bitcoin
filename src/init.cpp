 ...
 * between ascensiond, and ascension-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("ascension-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/ascensioncoin/AscensionCoin>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("ascension-loadblk");
    CImportingNow imp;
...
/** Sanity checks
 *  Ensure that Ascension is running in a usable environment with all
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // Make sure only a single Ascension process is using the data directory.
