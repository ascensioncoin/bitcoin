...
#if defined(NDEBUG)
# error "Ascension cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Ascension Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s ASN additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("ascension-scriptch");
